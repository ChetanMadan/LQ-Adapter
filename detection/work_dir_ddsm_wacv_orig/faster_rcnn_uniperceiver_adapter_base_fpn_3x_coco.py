...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/ddsm/annotations/train_new.json',
        img_prefix='data/ddsm/imgs',
        classes=('mal', ),
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=False),
    ...
    val=dict(
        type='CocoDatasetCustom',
        ann_file='data/ddsm/annotations/val_new.json',
        img_prefix='data/ddsm/imgs',
        classes=('mal', ),
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        type='CocoDatasetCustom',
        ann_file='data/ddsm/annotations/test_new.json',
        img_prefix='data/ddsm/imgs',
        classes=('mal', ),
        pipeline=[
            dict(type='LoadImageFromFile'),
...
work_dir = 'work_dir_ddsm_wacv_orig'
auto_resume = True
gpu_ids = range(0, 2)
device = 'cuda'
